...
## Contenidos
Para esta prueba de concepto se utilizan contenidos de prueba incorporados en la carpeta `content/units` que se pueden editar en el backend remoto de NetlifyCMS o localmente con TinaCMS.
